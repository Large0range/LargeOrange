...
fn CreateHashMap() -> HashMap<String, fn(&[&str], &mut HashMap<String, String>)> { //create the hash map for instruction to function saving
    let TokenHashMap: HashMap<String, fn(&[&str], &mut HashMap<String, String>)> = HashMap::from([
        ("remember".to_string(), keywordCallbacks::remember as fn(&[&str], &mut HashMap<String, String>)), // remember instruction
        ("say".to_string(), keywordCallbacks::say as fn (&[&str], &mut HashMap<String, String>)),          // say instruction
        ("add".to_string(), keywordCallbacks::add as fn(&[&str], &mut HashMap<String, String>)), // add instruction
        ("sub".to_string(), keywordCallbacks::sub as fn(&[&str], &mut HashMap<String, String>)), // sub instruction
        ("mul".to_string(), keywordCallbacks::mul as fn(&[&str], &mut HashMap<String, String>)), // mul instruction
        ("div".to_string(), keywordCallbacks::div as fn(&[&str], &mut HashMap<String, String>)), // div instruction
    ]);
